...
import com.productivesocial.com.productivesocial.model.ApiError
import com.productivesocial.com.productivesocial.model.FieldError
import com.productivesocial.com.productivesocial.utils.AppException
import com.productivesocial.com.productivesocial.utils.InvalidEnumValueException
import com.productivesocial.com.productivesocial.utils.MissingParameterException
        ...
        exception<Throwable> { call, error ->
            when (error) {
                is InvalidEnumValueException -> {
                    ...
                    call.respond(status = error.code, message = ApiError(message = error.message ?: "Invalid value"))
                }
                is MissingParameterException -> {
                    call.respond(status = error.code, message = ApiError(message = error.message ?: "Missing Parameter"))
                }
                is AppException -> {
