...
class RoutineCompletionLogDAO(id: EntityID<Long>) : BaseEntity(id, RoutineCompletionLogTable) {
    ...
    var routine by RoutineDAO.Companion referencedOn RoutineCompletionLogTable.routineId
    ...
    val stepCompletionLogs by RoutineStepCompletionLogDAO.Companion optionalReferrersOn RoutineStepCompletionLogTable.routineCompletionLogId
}
