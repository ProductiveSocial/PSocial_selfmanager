...
class SubtaskDAO(id: EntityID<Long>) : BaseEntity(id, SubtaskTable) {
    ...
    val completionLogs by SubtaskCompletionLogDAO.Companion referrersOn SubtaskCompletionLogTable.subtaskId
...
class SubtaskCompletionLogDAO(id: EntityID<Long>) : BaseEntity(id, SubtaskCompletionLogTable) {
    ...
    var taskCompletionLog by TaskCompletionLogDAO.Companion optionalReferencedOn SubtaskCompletionLogTable.taskCompletionLogId
}
