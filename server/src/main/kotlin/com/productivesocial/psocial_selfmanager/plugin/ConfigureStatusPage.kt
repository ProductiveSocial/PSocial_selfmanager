...
import com.productivesocial.psocial_selfmanager.utils.InvalidEnumValueException
import com.productivesocial.psocial_selfmanager.utils.MissingParameterException
import com.productivesocial.psocial_selfmanager.model.ApiError
...
fun Application.configureStatusPage() {
    install(StatusPages) {
            ...
            when (error) {
                ...
                is MissingRequestParameterException ->
                    call.respond(HttpStatusCode.BadRequest,
                        ApiError(
                            "Missing parameter: ${error.parameterName}"
                        )
                    )
        ...
        status(HttpStatusCode.Unauthorized) { call, _ ->
            call.respond(HttpStatusCode.Unauthorized, message = ApiError(
